...
Defined in: [server/expressMiddleware.ts:37](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/expressMiddleware.ts#L37)
...
Defined in: [server/socketServer.ts:23](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/socketServer.ts#L23)
...
Defined in: [server/spokestackASRService.ts:9](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L9)

##### language

• `Optional` **language**: _en_

Defined in: [server/spokestackASRService.ts:10](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L10)

##### limit

• `Optional` **limit**: _number_

Defined in: [server/spokestackASRService.ts:11](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L11)

##### sampleRate

• **sampleRate**: _number_

Defined in: [server/spokestackASRService.ts:12](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L12)
...
Defined in: [server/spokestackASRService.ts:27](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L27)
...
Defined in: [server/spokestackASRService.ts:21](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L21)
...
Defined in: [server/asr.ts:43](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/asr.ts#L43)
...
Defined in: [server/socketServer.ts:108](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/socketServer.ts#L108)
...
Defined in: [server/asr.ts:106](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/asr.ts#L106)
...
Defined in: [server/spokestackASRService.ts:74](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L74)
...
Defined in: [server/spokestackASRService.ts:48](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L48)
...
Defined in: [server/spokestackASRService.ts:57](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L57)
...
Defined in: [server/spokestackASRService.ts:64](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L64)

##### status

• **status**: _ok_ \| _error_

Defined in: [server/spokestackASRService.ts:46](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L46)
...
Defined in: [server/spokestackASRService.ts:41](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L41)

##### transcript

• **transcript**: _string_

Defined in: [server/spokestackASRService.ts:42](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L42)

#### ASRFormat

• **LINEAR16**: = "PCM16LE"

Defined in: [server/spokestackASRService.ts:5](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/spokestackASRService.ts#L5)
...
Defined in: [server/encryptSecret.ts:13](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/server/encryptSecret.ts#L13)
...
Defined in: [client/record.ts:84](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/record.ts#L84)
...
Defined in: [client/record.ts:16](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/record.ts#L16)
...
Defined in: [client/record.ts:14](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/record.ts#L14)
...
Defined in: [client/record.ts:12](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/record.ts#L12)
...
Defined in: [client/recordStream.ts:43](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/recordStream.ts#L43)
...
Defined in: [client/recordStream.ts:96](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/recordStream.ts#L96)
...
Defined in: [client/convertFloat32ToInt16.ts:16](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/convertFloat32ToInt16.ts#L16)
...
Defined in: [client/pipeline.ts:161](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/pipeline.ts#L161)
...
Defined in: [client/SpeechPipeline.ts:40](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/SpeechPipeline.ts#L40)
...
Defined in: [client/SpeechPipeline.ts:85](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/SpeechPipeline.ts#L85)
...
Defined in: [client/SpeechPipeline.ts:203](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/SpeechPipeline.ts#L203)
...
Defined in: [client/SpeechPipeline.ts:19](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/SpeechPipeline.ts#L19)

##### speechConfig

• **speechConfig**: _SpeechConfig_

Defined in: [client/SpeechPipeline.ts:16](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/SpeechPipeline.ts#L16)

##### stages

• **stages**: _Stage_[]

Defined in: [client/SpeechPipeline.ts:17](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/SpeechPipeline.ts#L17)

##### workerUrl

• `Optional` **workerUrl**: _string_

Defined in: [client/SpeechPipeline.ts:18](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/SpeechPipeline.ts#L18)
...
Defined in: [client/pipeline.ts:30](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/pipeline.ts#L30)
...
Defined in: [client/pipeline.ts:36](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/pipeline.ts#L36)

#### SpeechEventType

• **Activate**: = "ACTIVATE"

Defined in: [client/types.ts:76](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L76)

• **Deactivate**: = "DEACTIVATE"

Defined in: [client/types.ts:77](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L77)

• **Error**: = "ERROR"

Defined in: [client/types.ts:80](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L80)

• **Recognize**: = "RECOGNIZE"

Defined in: [client/types.ts:79](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L79)

• **Timeout**: = "TIMEOUT"

Defined in: [client/types.ts:78](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L78)

#### Stage

• **KeywordRecognizer**: = "keyword"

Defined in: [client/types.ts:93](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L93)

• **VadTrigger**: = "vadTrigger"

Defined in: [client/types.ts:91](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L91)

• **WakewordTrigger**: = "wakeword"

Defined in: [client/types.ts:92](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/types.ts#L92)
...
Defined in: [client/pipeline.ts:195](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/pipeline.ts#L195)
...
Defined in: [client/countdown.ts:8](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/countdown.ts#L8)
...
Defined in: [client/processor.ts:22](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/processor.ts#L22)
...
Defined in: [client/processor.ts:8](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/processor.ts#L8)

##### processor

• **processor**: ScriptProcessorNode

Defined in: [client/processor.ts:9](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/processor.ts#L9)
...
Defined in: [client/processor.ts:50](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/processor.ts#L50)
...
Defined in: [client/concatenateAudioBuffers.ts:4](https://github.com/spokestack/node-spokestack/blob/10bf00c/src/client/concatenateAudioBuffers.ts#L4)
